  ...
  return (
    <Layout>
      ...
      <p>
        ...
        https://nextjs-football-eight.vercel.app/, unless otherwise defined in
        this Privacy Policy.
      </p>
      <h2 className="text-xl my-2">Information Collection and Use</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Log Data</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Cookies</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Service Providers</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Security</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Links to Other Sites</h2>
      <p>
      ...
      <h2 className="text-xl my-2">Changes to This Privacy Policy</h2>
      <p>
      ...
      <a className="my-2" href="mailto:help.soccersurvivor@gmail.com">
        help.soccersurvivor@gmail.com
      </a>
    </Layout>
  )
}
